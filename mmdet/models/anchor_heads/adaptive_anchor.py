...
class AdaptiveAnchorHead(AnchorHead):
    ...
    Args:
        ...
        loss_center (dict): Config of location loss.
    ...
    def get_anchors(self,
        ...
        Args:
            ...
            center_preds (list[tensor]): Multi-level location predictions.
            img_metas (list[dict]): Image meta info.
            use_center_filter (bool): Use loc filter or not.
            device (torch.device | str): device for returned tensors
        ...
        for img_id, img_meta in enumerate(img_metas):
            ...
            for i in range(num_levels):
                ...
                guided_anchors, center_mask = self.get_guided_anchors_single(
                    squares,
                    shape_pred,
                    center_pred,
        ...
        return squares_list, guided_anchors_list, center_mask_list
    ...
    def get_guided_anchors_single(self,
        ...
        Args:
            ...
            center_pred (tensor): Loc predections of a single level.
            use_center_filter (list[tensor]): Use loc filter or not.
    ...
    def loss(self,
        ...
        for i in range(len(center_preds)):
            loss_loc = self.loss_center_single(
                center_preds[i],
                loc_targets[i],
                loc_weights[i],
                center_avg_factor=loc_avg_factor,
                cfg=cfg)
